...
\ifthenelse{\equal{\Period}{proposal}}{\setcounter{tocdepth}{2}}{\setcounter{tocdepth}{3}}
...
\ifthenelse{\equal{\Degree}{undergraduate}}
{
    ...
    {
        \fancyhead{}
        \fancyhead[L]{\zihao{5} \songti \ifthenelse{\equal{\Period}{proposal}}{\Title}{浙江大学本科生毕业论文（设计）}}
        \fancyhead[R]{\zihao{5} \songti \ifthenelse{\equal{\Period}{proposal}}{\currentchapternumber 、 \currentchaptertitle}{\currentsectionnumber \enspace \currentsectiontitle}}
